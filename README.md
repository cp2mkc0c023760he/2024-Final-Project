...
### Milestone 2. Selection of symbols to predict (EUR pairs).
Choosing the specific currency pairs (EUR pairs) that will be the focus of the price prediction models.
### Milestone 3. Initial versions of LSTM & Transformer.
...
### Milestone 7. Evaluate different symbols
